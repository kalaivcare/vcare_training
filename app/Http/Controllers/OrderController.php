...
class OrderController extends Controller
{
    ...
    public function vieworder($id)
    {
        ...
        $money = Currency::where('currency',$show->currency)->first();
        if($show->currency == '')        {
            $money = Order::where('currency',$show->currency)->first();
        }
        return view('admin.order.view', compact('show', 'setting','money'));
    }
