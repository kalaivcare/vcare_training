...
class QuizTopicController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        if(isset($request->show_ans)){
         ...
         if(isset($request->final_assess)){
          $input['final_assess'] = "1";
        }else{
          $input['final_assess'] = "0";
        }
    ...
    public function show($id)
    {
        $topic = QuizTopic::where('id', $id)->first();
         $cate = Course::where('id',$topic['course_id'])->first();
        return view('admin.course.quiztopic.edit',compact('cate','topic'));
    }
    ...
    public function update(Request $request, $id)
    {
      ...
      // return $request;
        ...
        if(isset($request->pricechk)){
          ...
          $topic->due_hours = $request->due_hours;
          $topic->due_minutes = $request->due_minutes;
          ...
          if(isset($request->status)){
           ...
           if(isset($request->final_assess)){
          $topic['final_assess'] = "1";
        }else{
          $topic['final_assess'] = "0";
        }
