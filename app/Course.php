...
class Course extends Model
{
    ...
    protected $fillable = [
        'category_id','childcategory_id','subcategory_id', 'language_id', 'user_id', 'title','short_detail', 'detail',  'price', 'discount_price',  'price2', 'discount_price2','day','video',
        'video_url', 'featured','requirement','url','slug','status','preview_image', 'type', 'preview_type', 'duration','online_tutor_one','online_tutor_two','offline_tutor','hard_course',
        'offline_tutor2','online_tutor_one2','hard_course2','certified','weight','course_require','transcript_pdf','player_image'
    ];
