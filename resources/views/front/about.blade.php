        ...
        <div class="row no-gutters">
            ...
            <div class="col-lg-12">
                <div class="about-team-block text-center">
                    <div class="about-team-heading btm-20" style="color:#6f0f11;">
                        <img src="{{ asset('files/logo/'.$setting->logo) }}" class="img-fluid" width="150" height="150" alt="logo">{{ $about->five_heading }}</div>
                    <p class="btm-40" style="text-align:justify;"><span class="font-weight-bold">VCare,</span> {{ $about->five_text }}</p>
