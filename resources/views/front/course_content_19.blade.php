                    ...
                    <div class="progress-block">
                        <div class="one histo-rate">
                            <span class="bar-block" style="width: 100%">
                                <span id="bar-one" style="width: <?php echo $progres; ?>%" class="bar bar-clr bar-radius progress-bar-striped">&nbsp;</span> 
                            </span>
                        </div>
                            ...
                            <div class="card btm-10">
                                ...
                                <div id="collapseChapter{{ $coursechapter->id }}" class="collapse" aria-labelledby="headingChapter" data-parent="#accordion">
                                    ...
                                    @php
                                       ...
                                       $size = App\CourseClass::where('course_id',$course->id)->where('coursechapter_id',$coursechapter->id)->where('id',$class->id)->first();
                                    ...
                                    <div class="card-body">
                                        <table class="table" style="width: 100%;">  
                                            <tbody>
                                                <tr>
                                                    <td class="class-type content" style="width: 50%;">
                                                    ...
                                                    <td class="class-type content txt-rgt pdfvisiviewcheck" style="width: 20%;">
                                                        ...
                                                        @if($class->type =='video' && $class->video )
                                                          <a href="{{ route('watchcourseclass',$class->id) }}" id="completed" onclick="pdfvisiviewcheck('{{ $class->id }}', '{{ $coursechapter->id }}')" id="check" title="Course"  class="iframe"><i class="fas fa-eye"></i>&nbsp; View &nbsp;&nbsp; </a>
                                                        ...
                                                        @endphp
                                                        @if($class->type =='video' && $class->iframe_url )
                                                        <a href="{{ route('watchinframe',[$url, 'course_id' => $course->id]) }}" onclick="pdfvisiviewcheck('{{ $class->id }}', '{{ $coursechapter->id }}')" title="Course"><i class="fas fa-eye"></i>&nbsp; View &nbsp;&nbsp; </a>
                                                      
                                                        @endif
                                                        @if($class->type =='audio' && $class->audio)
                                                        <a href="{{ route('audiocourseclass',$class->id) }}" title="class" onclick="pdfvisiviewcheck('{{ $class->id }}', '{{ $coursechapter->id }}')" class="iframe"><i class="fas fa-eye"></i>&nbsp; View &nbsp;&nbsp;</a>
                                                        @endif
                                                        @if($class->type =='image' && $class->image )
                                                        <a href="{{ asset('images/class/'.$class->image) }}" onclick="pdfvisiviewcheck('{{ $class->id }}', '{{ $coursechapter->id }}')" download="{{$class->image}}" title="Course"><i class="fas fa-eye"></i>&nbsp; View &nbsp;&nbsp; </a>
                                                        @endif
                                                        @if($class->type =='pdf' && $class->pdf )
                                                        ...
                                                        @endif
                                                        @if($class->type =='zip' && $class->zip )
                                                        <a href="{{ asset('files/zip/'.$class->zip) }}" onclick="pdfvisiviewcheck('{{ $class->id }}', '{{ $coursechapter->id }}')" download="{{$class->zip}}" title="Course"><i class="fas fa-eye"></i>&nbsp; View &nbsp;&nbsp; </a>
                                                        @endif
                                                        @if($class->url)
                                                            @if($class->type =='video')
                                                            @if($mytime >= $class->date_time)
                                                            <a href="{{ route('watchcourseclass',$class->id) }}" onclick="pdfvisiviewcheck('{{ $class->id }}', '{{ $coursechapter->id }}')" title="Course" class="iframe"><i class="fas fa-eye"></i>&nbsp; View &nbsp;&nbsp; </a>
                                                            @else
                                                            <a href="" onclick="pdfvisiviewcheck('{{ $class->id }}', '{{ $coursechapter->id }}')" title="Course"><i class="fas fa-eye"></i>&nbsp; View &nbsp;&nbsp;</a>
                                                            @endif
                                                            @endif
                                                            @if($class->type =='image')
                                                            <a href="{{ $class->url }}" onclick="pdfvisiviewcheck('{{ $class->id }}', '{{ $coursechapter->id }}')" title="Course"><i class="fas fa-eye"></i>&nbsp; View &nbsp;&nbsp; </a>
                                                            @endif
                                                            @if($class->type =='pdf')
                                                            ...
                                                            @endif
                                                            @if($class->type =='zip')
                                                            <a href="{{ $class->url }}" onclick="pdfvisiviewcheck('{{ $class->id }}', '{{ $coursechapter->id }}')" title="Course"><i class="fas fa-eye"></i>&nbsp; View &nbsp;&nbsp; </i></a>
                                                            @endif
                                                            @if($class->type =='audio')
                                                            <a href="{{ route('audiocourseclass',$class->id) }}" onclick="pdfvisiviewcheck('{{ $class->id }}', '{{ $coursechapter->id }}')" title="Course" class="iframe"><i class="fas fa-eye"></i>&nbsp; View &nbsp;&nbsp;</a>
                                                            @endif
                                                        @endif 
                                                    </td>
                                                    ...
                                                    <td class="class-type content txt-rgt pdfvisicheck" style="width: 20%;">
                                                        ...
                                                        @if($class->type =='video' && $class->video )
                                                          <a href="{{ route('watchcourseclass',$class->id) }}" id="completed" onclick="pdfvisicheck('{{ $class->id }}', '{{ $coursechapter->id }}')" id="check" title="Course"  class="iframe"> </a>
                                                        ...
                                                        @endphp
                                                        @if($class->type =='video' && $class->iframe_url )
                                                        <a href="{{ route('watchinframe',[$url, 'course_id' => $course->id]) }}" onclick="pdfvisicheck('{{ $class->id }}', '{{ $coursechapter->id }}')" title="Course"> </a>
                                                      
                                                        @endif
                                                        @if($class->type =='audio' && $class->audio)
                                                        <a href="{{ route('audiocourseclass',$class->id) }}" title="class" onclick="pdfvisicheck('{{ $class->id }}', '{{ $coursechapter->id }}')" class="iframe"> </a>
                                                        @endif
                                                        @if($class->type =='image' && $class->image )
                                                        <a href="{{ asset('images/class/'.$class->image) }}" onclick="pdfvisicheck('{{ $class->id }}', '{{ $coursechapter->id }}')" download="{{$class->image}}" title="Course"><i class="fas fa-download"></i>&nbsp; Download</a>
                                                        @endif
                                                        @if($class->type =='pdf' && $class->pdf )
                                                        ...
                                                        @endif
                                                        @if($class->type =='zip' && $class->zip )
                                                        <a href="{{ asset('files/zip/'.$class->zip) }}" onclick="pdfvisicheck('{{ $class->id }}', '{{ $coursechapter->id }}')" download="{{$class->zip}}" title="Course"><i class="fas fa-download"></i>&nbsp; Download</a>
                                                        @endif
                                                        @if($class->url)
                                                            @if($class->type =='video')
                                                            @if($mytime >= $class->date_time)
                                                            <a href="{{ route('watchcourseclass',$class->id) }}" onclick="pdfvisicheck('{{ $class->id }}', '{{ $coursechapter->id }}')" title="Course" class="iframe"></a>
                                                            @else
                                                            <a href="" onclick="pdfvisicheck('{{ $class->id }}', '{{ $coursechapter->id }}')" title="Course"></a>
                                                            @endif
                                                            @endif
                                                            @if($class->type =='image')
                                                            <a href="{{ $class->url }}" onclick="pdfvisicheck('{{ $class->id }}', '{{ $coursechapter->id }}')" title="Course"><i class="fas fa-download"></i>&nbsp; Download</a>
                                                            @endif
                                                            @if($class->type =='pdf')
                                                            ...
                                                            @endif
                                                            @if($class->type =='zip')
                                                            <a href="{{ $class->url }}" onclick="pdfvisicheck('{{ $class->id }}', '{{ $coursechapter->id }}')" title="Course"><i class="fas fa-download">&nbsp; Download</i></a>
                                                            @endif
                                                            @if($class->type =='audio')
                                                            <a href="{{ route('audiocourseclass',$class->id) }}" onclick="pdfvisicheck('{{ $class->id }}', '{{ $coursechapter->id }}')" title="Course" class="iframe"></a>
                                                            @endif
                                                        @endif 
                                                    </td>
                                                     ...
                                                     @if(isset($classprog))
                                                       @if($class->type =='pdf')
                                                         <td  class="class-type content txt-rgt module_progress_block" style="width: 10%;padding-top: 20px;"><span class="module_progress">{{ round($module_progress) }}<span>%</span> </span></td>
                                                        @else
                                                         <td  class="class-type content txt-rgt module_progress_block" style="width: 10%;padding-top: 20px;"><span class="module_progress"></span></td>
                                                       @endif
                                                     @else
                                                         <td  class="class-type content txt-rgt module_progress_block" style="width: 10%;padding-top: 20px;"><span class="module_progress"></span></td>
                                                     @endif
                              ...
                              @if($topic->status == 1)
                                ...
                                @endphp
                                 ...
                                 @else
                                    <div class="m-auto" >
                                    <div class="col-lg-12">
                                        <h5>Complete all chapters and assessments to attend final assessment</h5>
