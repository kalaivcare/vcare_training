                            ...
                            <div class="about-home-rate mb-3">
                                <ul>
                                    ...
                                    @if( $course->discount_price == !NULL) 
                                        <li><i class=" {{ $money->icon }} "></i>{{  ceil($course->discount_price/$money->amount) }}</li>
                                        <li><span><s><i class="{{ $money->icon }}"></i>{{ ceil($course->price/$money->amount) }}</s></span></li>
                                    @else
                                        <li><i class="{{ $money->icon }} "></i>{{ ceil($course->price/$money->amount) }}</li>
                                    @endif
                            ...
                            @if(Auth::check())
                                ...
                                @else
                                    ...
                                    @else
                                        ...
                                        @else
                                            <div class="about-home-btn btm-20">
                                                <form id="demo-form2" method="post" action="{{ route('addtocart',['course_id' => $course->id, 'price' => ceil($course->price/$money->amount), 'discount_price' =>  ceil($course->discount_price/$money->amount) ]) }}"
                            ...
                            @php
                              if(Auth::check()){
                                $cart = App\Cart::where('user_id', Auth::User()->id)->where('course_id', $course->id)->first();
                                 ...
                                 $ordertutor = App\Order::where('user_id', Auth::User()->id)->where('course_id', $course->id)->get();
                                            ...
                                            @if( $rel->courses->type == 1)
                                                ...
                                                @if($rel->courses['discount_price'] == !NULL)
                                                    <div class="rate text-right">
                                                        <ul>
                                                            <li><a><b><i class="{{ $money->icon }}"></i>{{ $rel->courses['discount_price'] }}</b></a></li>&nbsp;
                                                            <li><a><b><strike><i class="{{ $money->icon }}"></i>{{ $rel->courses['price'] }}</strike></b></a></li>
                                                        </ul>
                                                    </div>
                                                @else
                                                    <div class="rate text-right">
                                                        <ul>
                                                            <li><a><b><i class="{{ $money->icon }}"></i>{{ $rel->courses['price'] }}</b></a></li>
                                                        </ul>
                                                    </div>
                                                @endif
                                            @else
