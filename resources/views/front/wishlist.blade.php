                    ...
                    <div class="wishlist-action">
                        <div class="row">
                        	<div class="col-md-6 col-6">
                                ...
                                @if($wish->courses->type == 1)
                                <div class="cart-btn">
                                    <form id="demo-form2" method="post" action="{{ route('addtocart',['course_id' => $wish->courses->id, 'price' => round($wish->courses->price/$money->amount), 'discount_price' => round($wish->courses->discount_price/$money->amount) ]) }}"
