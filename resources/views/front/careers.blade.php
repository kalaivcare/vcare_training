    ...
    <div class="container">
        <div class="careers-block">
            <div class="row justify-content-center">
                ...
                <div class="careers-btn btm-40 text-center text-white">
                    <p>Upcoming openings will be posted shortly.</p>
                    <p>In case if you do not want to miss an oppurtunity, please send your resume to <span class="text-danger">info@nihaws.com</span></p>
...
<section id="careers-video" class="careers-video-main-block">
    <div class="container">
        <div class="careers-video">
            <a href="#" title="about">
                <img src="{{ asset('images/careers/'.$data->one_video) }}" class="img-fluid career-image" alt="about-img">
            </a>
        </div>
    </div>
</section>
