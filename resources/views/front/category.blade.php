                ...
                <div class="row">
                    ...
                    <div class="col-md-7">
                        <div class="categories-popularity-dtl">
                            ...
                            <p class="btm-20">{{ str_limit($course->short_detail, $limit = 250, $end='...') }}</p>
                    ...
                    <div class="course-bought-block protip" data-pt-placement="outside" data-pt-interactive="false" data-pt-title="#prime-next-item-description-block{{$course->id}}">
                        <div class="row">
                            <div class="col-lg-4 col-md-4">
                                @if($course['preview_image'] !== NULL && $course['preview_image'] !== '')
                                    <a href="{{ route('user.course.show',['id' => $course->id, 'slug' => $course->slug ]) }}">
                                        {{--<img src="{{ asset('images/course/'.$course->preview_image) }}" alt="course" class="img-fluid">--}}
                                        <img src="{{ env('AWS_URL').('Storage/images/course/'.$course->preview_image) }}" alt="course" class="img-fluid">
                                        </a>
                                @else
                            ...
                            <div class="col-lg-6 col-md-6">
                                <div class="categories-popularity-dtl">
                                    ...
                                    <p>{{  str_limit($course->short_detail, $limit = 250, $end = '..') }}</p>
                                </div>
                            </div>
                                    ...
                                    <ul>
                                    	@if($course->type == 1)
                                            ...
                                            @if(ceil($course->discount_price/$money->amount) == !NULL) 
                                                <li class="rate-r"><i class="{{ $money->icon }}"></i>{{ ceil($course->discount_price/$money->amount) }}&nbsp;<s><i class="{{ $money->icon }}"></i>{{  ceil($course->price/$money->amount) }}</s> </li>
                                            @else
                                                <li class="rate-r"><i class="{{ $money->icon }}"></i>{{ ceil($course->price/$money->amount) }}</li>
                                            @endif
                                        @else
