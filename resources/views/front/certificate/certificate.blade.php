        ...
        <div class="row">
            ...
            <div class="col-lg-3">
                ...
                <div class="download-btn btm-20">
                 ...
                 <div class="download-btn btm-20">
                    <button type="submit" data-toggle="modal" data-target="#originalCirtificate" class="btn btn-secondary">Buy Hard Copy of Certificate</button>
                </div>
                <div class="download-btn btm-20">
                Refer your friend and get discounts for your next course : 
                    <a href=""> {{ Auth::user()->referral_link }}</a>

                </div>
                
                <div class="modal fade" id="originalCirtificate" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
                    <div class="modal-dialog modal-lg" role="document">
                      <div class="modal-content">
                        <div class="modal-header">
                          <h4 class="modal-title" id="myModalLabel">Get Original Certificate</h4>
                          <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                        </div>
                        <div class="box box-primary">
                          <div class="panel panel-sum">
                            <div class="modal-body">
                            <form id="demo-form2" method="post" action="{{route('originalcertificate',$course->id)}}" data-parsley-validate class="form-horizontal form-label-left" enctype="multipart/form-data">
                {{ csrf_field() }}
                ...
                <input type="hidden" name="course_id"  value="{{ $course->id }}" />
                 ...
                 <p>Price : <i class="{{ $currency['icon'] }}" style="font-size:13px;"></i> 300</p>
                <div class="btm-20">
                    <button type="submit" class="btn btn-success">Get Original Certificate</button>
                </div>
