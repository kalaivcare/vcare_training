...
@section('content')
    ...
    <section id="wishlist-home" class="wishlist-home-main-block">
        <div class="container">
            <h4 class="wishlist-home-heading text-white">
                                    ...
                                    <div class="item first">
                                        <div class="course-bought-section protip" data-pt-placement="outside"
                                            ...
                                            <div class="view-heading btm-10">
                                                ...
                                                <a
                                                    href="{{ url('show/coursecontent', $course->id) }}">{{ str_limit($course->title, $limit = 30, $end = '...') }}</a>
                                            </div>
                                                ...
                                                {{-- <ul>
                                                    ...
                                                    @if ($course->type == 1)
                                                        @if ($course->discount_price == !null)
                                                            <li class="rate-r"><s><i
                                                                        class="{{ $currency->icon }}"></i>{{ $course->price }}</s>&nbsp;<i
                                                ...
                                                {{-- <div class="rating">
                                                    <ul>
                                                        <li>
                                                            ...
                                                            @else
                                                                <div>
                                                                    <p>{{ __('frontstaticword.NoRating') }}</p>
                                                                </div>
                                                            @endif
                                                        </li>
