...
<section id="wishlist-home" class="wishlist-home-main-block">
    <div class="container">
        <h1 class="wishlist-home-heading text-white">Payment Receipt</h1>
    </div>
</section> 
<!-- about-home end -->
        ...
        <div class="view-order">
          <div class="row invoice-info">
              <div class="col-sm-4 invoice-col">
                From:
                  <address>
                   ...
                   <small style="color:;"><strong>(A unit of Ginerva Global Trading Corp LLP)</strong></small><br>
              ...
              <div class="col-sm-4 invoice-col">
                ...
                @if($orders->status ==1)
                  <span class="badge badge-success">{{ __('frontstaticword.Recieved') }}</span>
                @else 
                  <span class="badge badge-danger">{{ __('frontstaticword.Pending') }}</span>
                @endif
                </br>
