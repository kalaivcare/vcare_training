    ...
    <div class="col-md-12">
          ...
          <div class="instructor-detail">
          	<ul>
                ...
                @endif
          		...
          		<li>Phone Number: {!! $appoint->phone_no !!}</li>
          	</ul>
          </div>
    		</div>
        ...
        <form action="{{route('appointment.update',$appoint->id)}}" method="POST" enctype="multipart/form-data">
            ...
            <div class="row">
              ...
              <div class="col-md-4">
                <label for="exampleInputTit1e">Payment Status (1 hour): </label>
                <br>
                @if($orders['online_tutor_one']!=NULL)
              ...
              <div class="col-md-4">
                <label for="exampleInputTit1e">Payment Status (2 hours): </label>
                <br>
                @if($orders['online_tutor_two']!=NULL)
                <button class="btn btn-success">Paid</button>
                @else
                <button class="btn btn-primary">Pending</button>
                @endif               
             ...
             <div class="row">
                  <div class="col-md-6">
                     <div class="form-group">                   
                         ...
                         <input type="month" class="form-control" id="date" name="date" value="{{  $appoint['date'] }}">
                     </div>
                  </div>
               </div>
