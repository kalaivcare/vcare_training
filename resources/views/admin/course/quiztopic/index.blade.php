        ...
        <table id="example1" class="table table-bordered table-striped">
          ...
          <tr>
            ...
            <td><?php echo $i;?></td>
              ...
              <td>{{$topic->due_hours}} hrs {{ $topic->due_minutes}} mins</td>
                ...
                <br>
                  ...
                  <div class="row">
                        <div class="col-md-12">
                          ...
                          <select name="coursechapter_id" class="form-control">
                @php
                $coursechapters = App\CourseChapter::where('course_id',$cor->id)->get();
                @endphp  
                @foreach($coursechapters as $cat)
                    <option value="{{ $cat->id }}">{{ $cat->chapter_name }}</option>
                @endforeach
              </select>
                        </div>
                      </div>
                ...
                <div class="row">
                        <div class="col-md-12">
                          ...
                          <small>(Hours after quiz will start when user enroll in course)</small>
                            <div class="row">
                                <div class="col-md-3">
                                      <input type="text" placeholder="Enter in Hours" class="form-control" name="due_hours" id="exampleInputTitle" value="">
                                </div>
                                <div class="col-md-3">
                                      <input type="text" placeholder="Enter in Minutes" class="form-control" name="due_minutes" id="exampleInputTitle" value="">
                                </div>
                            </div>
