        ...
        <div class="box-body">
          <div class="nav-tabs-custom">
            ...
            <ul class="nav nav-tabs" id="nav-tab" role="tablist">
              ...
              <li  class=""  role="presentation"><a href="#modulerating" aria-controls="settings" role="tab" data-toggle="tab">Module rating</a></li>
            ...
            <div class="tab-content">
              ...
              <div role="tabpanel" class="fade tab-pane" id="appoint">
               ...
               <div role="tabpanel" class="fade tab-pane" id="modulerating">
                @include('admin.course.modulerating.index')
              </div>
