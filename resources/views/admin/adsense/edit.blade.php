			            ...
			            <div class="row">
    						<div class="col-md-4">
    							<div class="form-group">
									...
									<li class="tg-list-item">              
							            <input class="tgl tgl-skewed" id="statuss" type="checkbox" name="status" @if($ad!=Null) {{ $ad['status'] == 1 ? 'checked' : '' }} @endif>
    						...
    						<div class="col-md-4">
    							<div class="form-group">
									...
									<li class="tg-list-item">              
							            <input class="tgl tgl-skewed" id="ishome" type="checkbox" name="ishome" @if($ad!=Null) {{ $ad['ishome'] == 1 ? 'checked' : '' }} @endif>
    						...
    						<div class="col-md-4">
    							<div class="form-group">
									...
									<li class="tg-list-item">              
							            <input class="tgl tgl-skewed" id="iscart" type="checkbox" name="iscart" @if($ad!=Null) {{ $ad['iscart'] == 1 ? 'checked' : '' }} @endif>
    						...
    						<div class="col-md-4">
    							<div class="form-group">
									...
									<li class="tg-list-item">              
							            <input class="tgl tgl-skewed" id="iswishlist" type="checkbox" name="iswishlist" @if($ad!=Null) {{ $ad['iswishlist'] == 1 ? 'checked' : '' }} @endif>
    						...
    						<div class="col-md-4">
    							<div class="form-group">
									...
									<li class="tg-list-item">              
							            <input class="tgl tgl-skewed" id="isdetail" type="checkbox" name="isdetail" @if($ad!=Null) {{ $ad['isdetail'] == 1 ? 'checked' : '' }} @endif>
    						...
    						<div class="col-md-4 display-none">
    							<div class="form-group">
									...
									<li class="tg-list-item">              
							            <input class="tgl tgl-skewed" id="isviewall" type="checkbox" name="isviewall" @if($ad!=Null) {{ $ad['isviewall'] == 1 ? 'checked' : '' }} @endif>
