...
{{-- 
            ...
            <div class="row">
              <div class="col-md-6">
                ...
                <span id="imgError" class="text-danger d-block mt-1"></span>
              </div>
              <div class="col-md-6">
                @if($user->user_img != null || $user->user_img !='')
                  <div class="edit-user-img">
                    <img src="{{ url('/images/user_img/'.$user->user_img) }}" class="img-fluid" alt="User Image">
                  </div>
                @else
                  <div class="edit-user-img">
...
document.getElementById('user_img').addEventListener('change', function () {
    ...
    if (file) {
        if (!allowedTypes.includes(file.type)) {
            errorMsg.textContent = "Invalid file format! Please upload JPG, JPEG, PNG, GIF, BMP, or WebP only.";
