      ...
      <div class="col-md-12">
        <div class="box box-primary">
            <div class="box-header with-border"> 
              <h3 class="box-title">{{ __('adminstaticword.Add') }} {{ __('adminstaticword.Accreditation') }}</h3>
            </div>
            <div class="box-body">
              <form id="demo-form2" method="post" action="{{url('accreditation/')}}" data-parsley-validate class="form-horizontal form-label-left" enctype="multipart/form-data">
                {{ csrf_field() }}
