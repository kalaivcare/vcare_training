    ...
    <div class="col-md-12">
      ...
      <div class="box box-primary">
        <div class="box-header with-border">
          <div class="row">
            <div class="col-md-10">
              <h3 class="box-title"> {{ __('adminstaticword.Add') }} Workshop</h3>
            </div>
            <div  class="col-md-2">
            ...
            <form action="{{url('workshop/')}}" method="post" enctype="multipart/form-data">
              ...
              <div class="row">
                <div class="col-md-6">
                  ...
                  <textarea name="short_detail" rows="3" maxlength="210" class="form-control" placeholder="Enter Your Detail" required ></textarea>
                </div>
                <div class="col-md-6">
              ...
              <div class="row">
                ...
                <div class="col-md-3">
                  ...
                  <div class="display-none" id="pricebox">
                    ...
                    <input type="text" class="form-control" name="price" id="priceMain" placeholder="Please Enter Your price" value="">
        
                    <label for="exampleInputSlug">{{ __('adminstaticword.DiscountPrice') }} ({{ $money->currency }} <i class="{{ $money->icon }}"></i>): </label>
                    <input type="text" class="form-control" name="discount_price" id="offerPrice" placeholder="Please Enter Your discount_price" value="">
                  </div>
