	          		...
	          		<form action="{{ route('instructor.update') }}" method="POST">
		                ...
		                <div class="row">
							...
							<div class="col-md-12">
								...
								<div class="input-group">
					                ...
					                <input min="1" max="100" class="form-control" name="instructor_revenue" type="number" value="" id="revenue"  placeholder="Enter revenue percentage" class="{{ $errors->has('instructor_revenue') ? ' is-invalid' : '' }} form-control">
						...
						<div class="row">
							...
							<div class="col-md-12">
								...
								<div class="input-group">
					                ...
					                <input min="1" max="100" class="form-control" name="admin_revenue" type="number" value="" id="revenue"  placeholder="Enter revenue percentage" class="{{ $errors->has('admin_revenue') ? ' is-invalid' : '' }} form-control" >
					                <span class="input-group-addon"><i class="fa fa-percent"></i></span>
					             </div>
						...
						<div class="row">
							<div class="col-md-12">
								...
								<li class="tg-list-item">              
						            <input class="tgl tgl-skewed" id="paytm" type="checkbox" name="paytm_enable" >
						...
						<div class="row">
							<div class="col-md-12">
								...
								<li class="tg-list-item">              
						            <input class="tgl tgl-skewed" id="paypal" type="checkbox" name="paypal_enable" >
						...
						<div class="row">
							<div class="col-md-12">
								...
								<li class="tg-list-item">              
						            <input class="tgl tgl-skewed" id="bank" type="checkbox" name="bank_enable" >
