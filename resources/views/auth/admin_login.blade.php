        ...
        <div class="row">
                ...
                <div class="logo text-center btm-10">
                    ...
                    @if($logo->logo_type == 'L')
                        <a href="{{ url('/') }}" title="logo">
                            <!--<img src="{{ asset('images/logo/'.$logo->logo) }}" class="img-fluid" alt="logo">-->
                            <img src="{{ env('AWS_URL').('Storage/images/logo/'.$logo->logo) }}" class="img-fluid" alt="logo">
                            </a>
                    @else()
            ...
            <div class="col-lg-4">
                <div class="Login-btn txt-rgt">
                    {{-- <a href="{{ route('register') }}" class="btn btn-sm btn-primary" title="instructor">{{ __('frontstaticword.Signup') }}</a> --}}
                </div> 
            </div>
        </div>
    </div>
    ...
    <div class="container">
        <div class="col-md-6 offset-md-3">
            ...
            <div class="signup-block">
                ...
                <form method="POST" class="signup-form" action="{{ route('admin.login.submit') }}">
                    @csrf
                 
                    <div class="form-group">
                        <i class="fa fa-envelope" aria-hidden="true"></i>
                        <input id="email" type="email" class="form-control form-control-sm{{ $errors->has('email') ? ' is-invalid' : '' }}" placeholder="Enter Your E-Mail"   name="email" value="{{ old('email') }}" required autofocus>
                    ...
                    <div class="form-group">
                       ...
                       <div class="input-group-append">
                           <span toggle="#password-field" style="padding: 14px;padding-right: 29px; background-color:#06193a;" class="fa fa-fw fa-eye-slash field_icon toggle-password input-group-text"></span>
