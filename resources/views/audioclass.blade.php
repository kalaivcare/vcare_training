		...
		<script type="text/javascript">
			FWDUVPUtils.onReady(function(){
				...
				new FWDUVPlayer({		
					...
					thumbnailNormalBackgroundColor:"#fff",
					thumbnailHoverBackgroundColor:"#fff",
					thumbnailDisabledBackgroundColor:"#fff",
					...
					//audio visualizer
					audioVisualizerLinesColor:"#fff",
					audioVisualizerCircleColor:"#fff",
					//lightbox settings
	...
	<body class="player-course-chapter">
		...
		<ul id="courseplaycontent{{ $class->id }}" class="display-none">
				...
				<li 
					...
					@if($class->courses['player_image'] !== NULL && $class->courses['player_image'] !== '')
				    	data-poster-source="{{ url('images/class/player_image/'.$class->courses['player_image']) }}"
				    @else
				    	data-poster-source="{{ url('images/default/user.jpg') }}"
				    @endif 
					...
					@endphp
					    ...
					    <div data-video-short-description="">
					    	 <p class="minimalDarkCategoriesTitle" style="font-size:15px;"><span class="minimialDarkBold">Title: </span>{{ $class->title }}</p>
 	    	 			 	 <p class="minimalDarkCategoriesType" style="font-size:15px;"><span class="minimialDarkBold">Module: </span>{{ $class->coursechapters->chapter_name }}</p>
		        			 <p class="minimalDarkCategoriesDescription" style="font-size:15px;"><span class="minimialDarkBold">Course: </span>{{ $class->courses->title }}</p>
					    </div>
