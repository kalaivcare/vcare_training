...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		?>
		<style>
		    .fwduvp-video-holder div:nth-child(4) img{
		...
		<ul id="courseplaycontent{{ $class->id }}" class="display-none">
				...
				@php
					...
					if($class->url != ''){
						...
						$url = url('files/audio/1637232081INTRODUCTION ABOUT TRICHOLOGY.mp3');
					}
				...
				<li 
					...
					data-video-source="{{ $url }}"
						...
						@if($class->player_image !== NULL && $class->player_image !== '')
				    	data-poster-source="{{ url('images/class/player_image/'.$class->player_image) }}"
				    @else
